// OmpCustomMenuTest.cpp : Implementation of DLL Exports.
...
BEGIN_OBJECT_MAP( ObjectMap )
  OBJECT_ENTRY( CLSID_OmpCustomMenu, COmpCustomMenu )
END_OBJECT_MAP()
...
extern "C" BOOL WINAPI DllMain( HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved )
{
  ...
  {
    _AtlModule.Init( ObjectMap, hInstance );
...
STDAPI DllRegisterServer(void)
{
	...
	HRESULT hr = _AtlModule.RegisterServer();
	return hr;
}
...
{
	HRESULT hr = _AtlModule.UnregisterServer();
	return hr;
}
